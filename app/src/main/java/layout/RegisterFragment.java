...
//        } else {
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createDenuncia( user_id, titulo, descripcion, latitud, longitud, address);
...
//                RequestBody user_nombrePart = RequestBody.create(MultipartBody.FORM, user_nombre);
            ...
            call = service.createDenunciaWithImage(user_idPart, tituloPart, descPart, latitudPart, longitudPart, addressPart, imagenPart);
